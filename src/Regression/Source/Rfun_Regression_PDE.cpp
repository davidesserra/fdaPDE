...
extern "C"
{
  ...
  */
		           ...
		           SEXP Rbeta0, SEXP RfvarInference, SEXP RinferenceQuantile, SEXP RinferenceAlpha, SEXP RinferenceFlip, SEXP RinferenceTolFspai, SEXP RinferenceDefined)
  {
    RegressionDataElliptic regressionData(Rlocations, RbaryLocations, Rtime_locations, Robservations, Rorder, RK, Rbeta, Rc,
					  Rcovariates, RBCIndices, RBCValues, RincidenceMatrix, RarealDataAvg, Rflag_mass, Rflag_parabolic, Rflag_iterative, Rflag_finitedifferences, Rmax_num_iteration, Rtreshold,Ric, Rsearch);
  ...
  */
  SEXP gam_PDE_time(SEXP Rlocations, SEXP RbaryLocations, SEXP Rtime_locations, SEXP Robservations, SEXP Rmesh,
		    ...
		    SEXP Rflag_parabolic,SEXP Rflag_iterative, SEXP Rflag_finitedifferences, SEXP Rmax_num_iteration, SEXP Rthreshold, SEXP Ric,
		    ...
		    SEXP RDOF_matrix, SEXP Rtune, SEXP Rsct)
  {
    GAMDataElliptic regressionData(Rlocations, RbaryLocations, Rtime_locations, Robservations, Rorder, RK, Rbeta, Rc,
				   ...
				   Rflag_mass, Rflag_parabolic, Rflag_iterative, Rflag_finitedifferences, Rmax_num_iteration, Rthreshold, Ric,
