...
class  RegressionData
{
	...
	private:
		...
		bool flag_FiniteDifferences_{};   // TRUE if Finite Differences are implemented for time derivation
	...
	public:
		...
		*/
		...
		bool getFlagFiniteDifferences(void) const {return flag_FiniteDifferences_;}
